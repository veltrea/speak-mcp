...
- `src/main.rs`: Added 500ms and 30s timeouts to `reqwest` HTTP clients to prevent EOF freezes when TTS engines are offline or unresponsive during startup and synthesis.
